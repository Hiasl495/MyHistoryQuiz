 ...
 */
    ...
    /*
    *
    * ArrayList which sets up the listing of all questions and their corresponding 4 answers
    *
     */
    public List<IntermediaryMethods> processingQuestions(){
        ...
        List<String> answers = setupAnswerList(getResources().getString(R.string.ans1), getResources().getString(R.string.ans2), getResources().getString(R.string.ans3), getResources().getString(R.string.ans4));
        IntermediaryMethods question = new IntermediaryMethods(getResources().getString(R.string.quest1), answers, 1);
